...
public class PointshopActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xutils.get(getResources().getString(R.string.scoreshop), map, new Xutils.XCallBack() {
            ...
            public void onResponse(String result) {
                ...
                pointadapter pointadapter = new pointadapter(R.layout.pointitem, pointbean, PointshopActivity.this);
    ...
    @OnClick(R.id.okpointshop)
    public void onViewClicked() {
        ToastUtils.showToast(PointshopActivity.this,"购买失败");
    }
}
